...
/**
 * return the shpfun val in natural coords (xi, eta)
 * @param L the local id of shpfun
 */
...
/**
 * return the dof val in natural coords (xi, eta)
 * @param v the nodes' dof vals in a element
 */
...
/**
 * return the derivates of shpfun to natural coords
 * result.xi is derivates of shpfun to xi
 * result.eta is derivates of shpfun to eta
 * @param L the local id of shpfun
 */
...
/**
 * return the derivates of dof to natural coords
 * result.xi is derivates of dof to xi
 * result.eta is derivates of dof to eta
 * @param v the nodes' dof vals in a element
 */
...
/**
 * return the inner production of (du/dx) and (dv/dx), where x is reference coords not natural coords
 * @param du derivates of dof u to natural coords
 * @param du derivates of dof u to natural coords
 */
